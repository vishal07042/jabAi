...
while cap.isOpened():
    ...
    # Display jab counters on the screen
    cv2.putText(frame, f"Left Jab Count: {left_jab_count}", (50, 150),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
    cv2.putText(frame, f"Right Jab Count: {right_jab_count}", (50, 200),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
